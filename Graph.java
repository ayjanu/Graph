...
public class Graph {
	...
	// find lowest cost path from any Vertex to a tgt node
	private void findLowestPath(VNode[] pathLens, int vertIndex, Set<String> unvisited,
			PriorityQueue<Path> pathQ) {
		Vertex tgt = pathLens[vertIndex].getVert();
		for (Edge adj : tgt.adjacent) {
	 ...
	 * from the vertex to the vertices it connects to. eter weighted is false, 2
	 * and 3 shall equal each other.
	 * 
	 * <br>
	 * <br>
	 ...
	 * <br>
	 * <br>
	 * After this method is called the getAllPaths, getDiameter, and get longest
	...
	// class to store a vertex and the lowest cost from any other vertex to it
	private class VNode {
		private Vertex vert; // destination vertex
		private double lowestCostPath; // lowest cost from any other point to
										// vert
	...
	private static class Vertex {
		 ...
		 * totalUnweightedPathLength, and totalWeightedPathLength, are
		 * cumulative sum variables that are to be updated by the findAllPaths
		 * in the Graph class.
		 */
